...
def login():
	...
	if choice == "1":
		...
		# if they are not found call the login function again, starting the menu over.
...
def menu():
	...
	# python file is called while passing name, account_number, and amount.
	elif choice == "2":
		name = input("Enter name: ")
		account_number = input("Enter account number: ")
		amount = input("Enter opening amount: ")
		data_queries.add_record(name, account_number, amount)
		menu()
	...
	# Once entered, the search_database function in the data_quiries
	# python file is called while passing account_number.
	elif choice == "4":
		account_number = input("Enter account number: ")
		data_queries.search_database(account_number)
		menu()

	# if the user enters 5 then they are prompted to enter an account number 
	# and amount. Once entered, the update_amount function in the data_quiries
	# python file is called while passing account_number and amount.
	elif choice == "5":
		account_number = input("Enter account number to update: ")
		amount = input("Enter new amount: ")
		data_queries.update_amount(account_number, amount)
		menu()
	...
	# python file is called while passing account_number.
		...
		data_queries.delete_record(account_number)
		menu()

	# if the user enters 0 then the logout function is called, exiting the menu function.
	elif choice == "0":
		print("Loging out...\n")
		login()
